    ...
    >
      ...
      <div className="pt-20 pb-8 px-4 md:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <p className="mt-3 text-slate-600 dark:text-slate-300/90 text-lg md:text-xl font-light tracking-wide drop-shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 mt-8">
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          ...
          <button
            ...
            className="px-5 py-2 rounded-full bg-cyan-100 text-cyan-700 hover:bg-cyan-200 border border-cyan-200 dark:bg-cyan-500/10 dark:text-cyan-400 dark:hover:bg-cyan-500/20 dark:border-cyan-500/30 flex items-center gap-1.5 text-sm font-medium transition-all ml-2 backdrop-blur-sm"
          >
            <Plus size={16} />
            <span>{t.add}</span>
          </button>
        ...
        {filteredLinks.length > 0 ? (
          ...
          !aiResponse && (
            <div className="text-center py-24 text-slate-500 flex flex-col items-center animate-in fade-in duration-500">
              <div className="w-20 h-20 bg-slate-200 dark:bg-slate-800/50 rounded-full flex items-center justify-center mb-6 ring-1 ring-slate-300 dark:ring-slate-700 transition-colors backdrop-blur-sm">
